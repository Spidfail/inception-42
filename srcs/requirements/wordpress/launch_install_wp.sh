...
then
	...
	#wp core install --path=/var/www/html/wordpress --url="guhernan.42.fr" --title="Mot PReSSe" --admin_user="guhernan" --admin_password="wordpress" --admin_email="monemail@email.com" --allow-root
fi
